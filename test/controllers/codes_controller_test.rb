...
class CodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post codes_url, params: { code: { code: @code.code, user_id: @code.user_id, valid: @code.valid } }
    end
  ...
  test "should update code" do
    patch code_url(@code), params: { code: { code: @code.code, user_id: @code.user_id, valid: @code.valid } }
